                ...
                <DescriptionBox title="Pagination with useQuery and placeholderData">
                    ...
                    <ul>
                        <li>
                            ...
                            Tanstack Query cache the data for each page
                            separately.
                        </li>
                        <li>
                            <code>placeholderData</code> is used (previously{" "}
                            <code>keepPreviousData</code>). When fetching a new
                            page, Tanstack Query keeps displaying the data from
                            the <em>previous</em> page until the new data
                            arrives. This prevents the UI from jumping to a
                            loading state and provides a smoother experience.
                        </li>
                        <li>
